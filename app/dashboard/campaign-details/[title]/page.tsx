...
import { CountBox, CustomButton, Loader } from '@/app/components';
import { calculateBarPercentage, daysLeft, Donation  } from '@/app/utils';
import { thirdweb } from '@/app/assets';
import { contract } from '@/app/constants';

const CampaignDetails = ({ params }: { params: { title: string }}) => {
  const { address, getDonations, donate, getCampaignByTitle } = useCryptoContext()!
  const campaign = getCampaignByTitle(decodeURIComponent(params.title))
        ...
        <div className="flex-1">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              <div className="my-[20px] p-4 bg-[#16131a] rounded-[10px]">
