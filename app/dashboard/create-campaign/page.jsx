...
import { money } from '@/app/assets';
import { CustomButton, FormField, Loader } from '@/app/components';
import { checkIfImage } from '@/app/utils';
...
const CreateCampaign = () => {
  ...
  const {createCampaign} = useCryptoContext()
