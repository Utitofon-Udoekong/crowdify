...
import { logo, menu, search, thirdweb } from '@/app/assets';
import { navlinks, client } from '@/app/constants';
...
const Navbar = () => {
  ...
  const {address} = useCryptoContext()!
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        ...
        {/* <CustomButton 
          ...
          handleClick={async () => {
            if(address) router.push('/dashboard/create-campaign')
            else await connect({ client })
          }}
        /> */}
