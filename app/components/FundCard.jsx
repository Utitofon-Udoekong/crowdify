...
import { tagType, thirdweb } from '@/app/assets';
...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image }) => {
  ...
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] hover:shadow-md hover:shadow-[#b2b3bd] cursor-pointer">
      <img src={image} alt="fund" className="w-full h-[158px] object-cover rounded-[15px]"/>

      <div className="flex flex-col p-4">
        <div className="flex flex-row items-center mb-[18px]">
          <Image src={tagType} alt="tag" className="w-[17px] h-[17px] object-contain" width="17px" height="17px"/>
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          <div className="w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#13131a]">
            <Image src={thirdweb} alt="user" className="w-1/2 h-1/2 object-contain" width="50" height="50"/>
          </div>
